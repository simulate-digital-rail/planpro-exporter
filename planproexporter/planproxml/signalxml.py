...
class SignalXML(object):
    ...
    @staticmethod
    def get_control_memeber_xml(signal: Signal):
        return f"            <Stellelement>" + "\n" \
             + f"              <Identitaet>" + "\n" \
             + f"                <Wert>{signal.uuid}</Wert>" + "\n" \
             + f"              </Identitaet>" + "\n" \
             + f"              <Basis_Objekt_Allg>" + "\n" \
             + f"                <Datum_Regelwerk>" + "\n" \
    ...
    def get_signal_xml(signal: Signal):
        trip_length = f"{(signal.trip.get_length()):.3f}".replace(".", ",")
        ...
        return f"            <Signal>" + "\n" \
             ...
             + f"                </ID_TOP_Kante>" + "\n" \
             + f"                <Wirkrichtung>" + "\n" \
             + f"                  <Wert>{signal.direction}</Wert>" + "\n" \
             + f"                </Wirkrichtung>" + "\n" \
             + f"                <Seitlicher_Abstand>" + "\n" \
             + f"                  <Wert>{signal.side_distance:.3f}</Wert>" + "\n" \
             + f"                </Seitlicher_Abstand>" + "\n" \
             + f"              </Punkt_Objekt_TOP_Kante>" + "\n" \
             + f"              <Bezeichnung>" + "\n" \
             ...
             + f"                  </ID_Stellelement>" + "\n" \
             + f"                  <Signal_Funktion>" + "\n" \
             + f"                    <Wert>{signal.function.name}</Wert>" + "\n" \
             + f"                  </Signal_Funktion>" + "\n" \
             + f"                </Signal_Real_Aktiv>" + "\n" \
